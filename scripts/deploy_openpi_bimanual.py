...
from piperx_toolkit.deploy.policy_runner import BimanualActionSmoother, PolicyRunner
...
def build_parser() -> argparse.ArgumentParser:
    ...
    control.add_argument("--print-every", type=int, default=20, help="Print actions every N steps. 0 = silent.")
    ...
    smooth.add_argument("--lowpass-alpha", type=float, default=1.0, help="EMA weight on new action (1 = off).")
    smooth.add_argument("--max-joint-delta-rad", type=float, default=0.2, help="Per-step joint limit (absolute_joint).")
