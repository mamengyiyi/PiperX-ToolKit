...
def main() -> None:
    ...
    parser.add_argument("--front-device", default="4", help="OpenCV index or /dev/v4l/by-id/* path for front camera.")
    parser.add_argument("--left-wrist-device", default="", help="OpenCV index or /dev/v4l/by-id/* path. Empty writes black frames.")
    parser.add_argument("--right-wrist-device", default="", help="OpenCV index or /dev/v4l/by-id/* path. Empty writes black frames.")
